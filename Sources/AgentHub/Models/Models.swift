...
enum ToolKind: String, CaseIterable, Identifiable, Codable {
    ...
    case qoder = "Qoder"
    case qoderCN = "Qoder CN / Lingma"
    case trae = "TRAE / TraeCode"
    case qwenCode = "Qwen Code"
    case kimiCode = "Kimi Code"
    case baiduComate = "Baidu Comate"
    ...
    var iconName: String {
        ...
        case .codeBuddy: return "bubble.left.and.text.bubble.right"
        case .qoder: return "q.square"
        case .qoderCN: return "character.book.closed"
        case .trae: return "bolt.horizontal.circle"
        case .qwenCode: return "brain.head.profile"
        case .kimiCode: return "moon.stars"
        case .baiduComate: return "person.crop.circle.badge.checkmark"
